...
<body class="bg-gray-100 font-sans">
    ...
    <div class="max-w-5xl mx-auto p-4 sm:p-6 md:p-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-2xl font-bold text-gray-800 mb-4"><?php echo htmlspecialchars($isEditing ? 'Edit' : 'Create New'); ?> Assignment</h2>
            <form action="/controller/MusicSinger.php?action=<?php echo $isEditing ? 'edit' : 'add'; ?>" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <button type="<?php echo $editMode ? 'editmusic_button' : 'submit'; ?>" class="w-full bg-green-500 text-white font-bold py-2 px-4 rounded-md hover:bg-green-600 transition duration-200">
                    Assign
                </button>
            </form>
        </div>
